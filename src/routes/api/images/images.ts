...
imagesRoutes.get("/resize",
  check('filename',
  `filename does not exist try a different filename 
  through the following available choices [${getAvailableFiles('./assets/images')}]`)
  .exists().isIn(getAvailableFiles('./assets/images')),
